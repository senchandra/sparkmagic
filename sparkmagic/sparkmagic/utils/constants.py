...
POSSIBLE_SESSION_STATUS = [NOT_STARTED_SESSION_STATUS, IDLE_SESSION_STATUS, STARTING_SESSION_STATUS,
                           BUSY_SESSION_STATUS, ERROR_SESSION_STATUS, DEAD_SESSION_STATUS, SUCCESS_SESSION_STATUS, SHUT_DOWN_SESSION_STATUS]
...
POSSIBLE_AUTH = [NO_AUTH, AUTH_KERBEROS, AUTH_SSL]